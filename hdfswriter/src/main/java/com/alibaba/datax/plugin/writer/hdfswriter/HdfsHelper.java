                    ...
                    try {
                        ...
                        throw DataXException
                                .asDataXException(
                                        ...
                                        String.format(
                                                "您的配置文件中的列配置信息有误.尝试了string类型写入.但是失败了. 因为hdfs helper DataX 不支持数据库写入这种字段类型. 字段名:[%s], 字段类型:[%d]. 请修改表中该字段的类型或者不同步该字段.",
                                ...
                                try {
                                    ...
                                    throw DataXException
                                            .asDataXException(
                                                    HdfsWriterErrorCode.ILLEGAL_VALUE,
                                                    String.format(
                                                            "您的配置文件中的列配置信息有误.尝试了string类型写入.但是失败了.因为hdfs DataX 不支持数据库写入这种字段类型. 字段名:[%s], 字段类型:[%d]. 请修改表中该字段的类型或者不同步该字段.",
